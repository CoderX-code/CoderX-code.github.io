...
```
修改对应项目文件夹中.git/config 的相关配置，修改对应的url由原来的`git@github.com:xxx/xxx.git` 修改为 `git@github1:xxx/xxx.git` 和 `git@github2:xxx/xxx.git` （这里xxx替换为实际的项目路径）。测试执行 git pull
